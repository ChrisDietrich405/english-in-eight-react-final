        ...
        <div className="contact-form-text-area-container">
          <div className="contact-form">
            ...
            <div className="mb-3">
              ...
              <input type="text" id="footer-input" className="form-control footer-form-control" id="exampleFormControlInput1" placeholder="name" />
            </div>
            <div className="mb-3">
              <label for="exampleFormControlInput1" className="form-label"></label>
              <input type="email" id="footer-input" className="form-control footer-form-control" id="exampleFormControlInput1" placeholder="name@example.com" />
            </div>
          </div>
          <div>

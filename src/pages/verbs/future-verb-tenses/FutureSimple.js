  ...
  return (
    <>
      ...
      <p className="grammar-explanation-paragraph">
        ...
        haven't happened yet. For example, this year I <b>will change</b>{" "}
        careers. Use the simple future to talk about an action or condition that
        will begin and end in the future. There are two ways to express the
      ...
      <div className="page-body">
        ...
        <p>
          {" "}
          We use <b>will</b> with offers, promises, and refusals.
        </p>
        <ul className="page-examples">
          <li>You look tired. I will help you with the housework. (offer)</li>
          <li>
            I'll always be your friend. I will never disappoint you. (promise)
          </li>
          <li>He won't listen to you. (refusal)</li>
        </ul>
        <p>
          {" "}
          We use <b>going</b> to for previous plans and in situations where
      ...
      <Quiz
        ...
        questions={[
          {
            title:
              "I don't have anything to eat. That's ok. I _______ share my food with you.",
            possibleAnswers: [
          ...
          {
            title:
              "It's Nia's birthday next week, so we _____________ buy her a TV.",
            possibleAnswers: [
          ...
          {
            title:
              "Could you lend me $10? I promise  _______________ pay you back  tomorrow.",
            possibleAnswers: [
              { title: "a. am going to" },
          ...
          {
            title:
              "They ______________ have a barbecue tomorrow. It's all planned, so I hope it won't rain.",
            possibleAnswers: [
              { title: "a. are going to", correctAnswer: true },
              { title: "b. will" },
            ],
          ...
          {
            title:
              "Just a moment. I __________________ help you with the bags.",
            possibleAnswers: [
              { title: "a. am going to" },
              { title: "b. will", correctAnswer: true },
            ],

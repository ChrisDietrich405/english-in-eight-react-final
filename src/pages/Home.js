  ...
  return (
    <div className="home">
      <div className="container">
        <hr />
        <h1>
          Welcome to <span className="title-span">English in Eight Minutes</span>
        </h1>
        <p className="title-content">
          {" "}
          This website offers English lessons you can complete in less than 8 minutes. Pick a topic, study a few minutes, and then do the corresponding exercise. The focus is on English phrasal verbs, grammar, and idiomatic expressions specific to <b> the United States. </b>
        </p>
      </div>
      ...
      <div className="container card-container">
        ...
        <div className="row second-row">
          ...
          <div className="col-12 col-md-4 col-sm-6 ">
            <Link to="/present-verb-tenses/verb-definition">
              <div className="verb-examples">
                <i className="fas fa-comments comments fa-1.5x" aria-hidden="true"></i>

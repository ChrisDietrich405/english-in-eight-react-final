    ...
    return (
        <div className="comparative-adjectives">
            ...
            <div className="page-body">
                ...
                <p>But some two syllable adjectives can take  'er'. It's also fine to use 'more'.</p>
                <ul className="page-examples">
                ...
                <p>Adjectives with more than two syllables can only make their comparative by using 'more'.</p>
                <ul className="page-examples">
            ...
            <Quiz title="Quiz" questions={[
                ...
                {
                    title: "My Latin class is ______________ (boring) than my English class. ",
                    possibleAnswers: [
                ...
                {
                    title: "The streets here are  _______________ (narrow) than in Baltimore.",
                    possibleAnswers: [
                ...
                {
                    title: "Demetrius is ________________ (ambitious) than his colleagues.",
                    possibleAnswers: [
                        {title: "ambitiouser"},
                ...
                {
                    title: "My garden is  ________________  (colorful) than my neighbors.",
                    possibleAnswers: [
                        {title: "colorfuler"},

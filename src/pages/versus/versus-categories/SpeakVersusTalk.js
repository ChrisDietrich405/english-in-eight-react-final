  ...
  return (
    <div className="page-body">
      ...
      <p className="grammar-explanation-paragraph">
        The verbs speak and talk both generally mean ‘say words’, but there are
        some small differences in how they are used. Speak is more formal than
        talk.
      </p>
      <p>
        We usually use speak for more formal presentations and lectures, and
        talk for more informal ones:
      </p>
      <ul className="page-examples">
        <li>Dr Graham Foster will speak about the history of the region.</li>
        <li>
          Kyle is going to talk us through the benefits of the software and then
          Liz will talk about the marketing plan.
        </li>
      </ul>
      ...
      <p className="grammar-explanation-paragraph">
        Certain phrasal verbs require speak or talk. The two verbs in these
        situations are not interchangeable. Certain phrasal verbs require speak
        or talk. The two verbs in these situations are not interchangeable
      </p>
      <ul className="page-examples">
        <li>
          I need to talk it over with my wife before making a decision (to have
          a conversation to resolve an issue)
        </li>
        <li>Speak up! You’re talking too softly. (to speak louder)</li>
        <li>
          My boss always talks down to me. (to talk in a disrespectful way)
        </li>
      </ul>
      ...
      <Quiz
        ...
        questions={[
          ...
          {
            title:
              "We ________ today with Joyce Ann McConnell and Jackie King.",
            possibleAnswers: [
          ...
          {
            title:
              "After dinner we usually sit and ________ on the back porch.",
            possibleAnswers: [
              { title: "talk", correctAnswer: true },
              { title: "speak" },
            ],

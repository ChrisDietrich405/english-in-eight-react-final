  ...
  return (
    <div className="page-body">
      ...
      <p className="grammar-explanation-paragraph">
        We use both all and every to refer to the total number of something. All
        refers to a complete group. Every refers to each member of a complete
        group:
      </p>
      ...
      <ul className="page-examples">
        <li>
          All passengers must turn off their cell phones. (refers to the whole
          group)
        </li>
        <li>
          Every passenger must turn off their cell phone. (focuses on each
          individual member of the whole group)
        </li>
      </ul>
      <p>
        We can use all, but not every, on its own without a noun. We use
        everyone/everybody/everything instead:
      </p>
      <ul className="page-examples">
        <li>
        ...
        <li>
          The meeting is at Oriel Hall. It begins at 8 pm and everyone is
          welcome.
        </li>
      </ul>
      <p>
        We use all with plural and uncountable nouns and every with singular
        nouns:
      </p>
      <ul className="page-examples">
      ...
      <Quiz
        ...
        questions={[
          ...
          {
            title:
              " I have cleaned _______________ the rooms except the bathroom.",
            possibleAnswers: [
              { title: "all", correctAnswer: true },
              { title: "every" },
            ],

  ...
  return (
    <div className="page-body">
      ...
      <p className="grammar-explanation-paragraph">
        The verbs say and tell have similar meanings. They both mean "to
        communicate verbally with someone". But we often use them differently.
      </p>
      ...
      <p>
        We usually follow tell with a <b>personal object</b> (the person that we
        are speaking to). We usually use say without a personal object:
      </p>
      <ul className="page-examples">
        <li>
          She told <b>me</b> that she loved John.
        </li>
        <li>She said that she loved John.</li>
        <li>
          He told <b>everybody</b> that he had to leave.
        </li>
      ...
      <p>
        There are a few fixed phrases with tell. We can’t use say with these
        phrases:
      </p>
      <ul className="page-examples">
      ...
      <Quiz
        ...
        questions={[
          ...
          {
            title:
              "She _____________ me that she was going running this evening.",
            possibleAnswers: [
              { title: "said" },
          ...
          {
            title:
              "Demarcus  ___________ us that he couldn't come to the party.",
            possibleAnswers: [
              { title: "said" },
              { title: "told", correctAnswer: true },
            ],
          ...
          {
            title:
              "They _________ that they didn't want to meet us on Tuesday.",
            possibleAnswers: [
              { title: "said" },
              { title: "told", correctAnswer: true },
            ],

...
export default function PhrasalVerbs2() {
    return(
        ...
        <Quiz title="Quiz" questions={[
            {
                title: "I think he could _______________ peanut butter and jelly sandwiches. I always see him eating them.",
                possibleAnswers: [
            ...
            {
                title: "I can't believe I let my wife ______________ adopting another cat.",
                possibleAnswers: [
                    {title: "a. to go off"},
            ...
            {
                title: "My car's alarm is very sensitive. It ___________ if you walk past it.",
                possibleAnswers: [
